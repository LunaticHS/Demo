...
void ADemoCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Dun", IE_Pressed, this, &ADemoCharacter::Dun);
	PlayerInputComponent->BindAction("Dun", IE_Released, this, &ADemoCharacter::StopDun);
...
void ADemoCharacter::Dun()
{
	// calculate delta for this frame from the rate information
}

void ADemoCharacter::StopDun()
{
	// calculate delta for this frame from the rate information
}
